...
<div style="text-align: center;margin: 0 20px">
    <div style="margin-top: 150px">
      ...
      <div style="font-size: 14px;color:#706b62">在进入系统之前,请输入用户名和密码进行登录</div>
    </div>
    <div style="text-align: center;margin: 50px">
      <el-form :model="form" :rules="rule" ref="formRef">
        <el-form-item prop="username">
          <el-input v-model="form.username" maxlength="15" type="text" placeholder="用户名和邮箱">
            <template #prefix>
              <el-icon>
                <User />
              </el-icon>
  ...
  <div style="text-align: center;margin-top: 20px">
    <el-button @click="userLogin" style="width: 200px" type="success" plain>立即登录</el-button>
  </div>
